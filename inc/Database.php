...
class Database
{
	...
	************************/
	...
	{
		$stmt = $this->conn->prepare("SELECT firstName, middleName, familyName FROM person WHERE id = :id");
	...
	{
		$stmt = $this->conn->prepare("SELECT phoneNumber FROM person");
		$stmt->execute();
	...
	public function checkPerson($phoneNumber)
	{
		$stmt = $this->conn->prepare("SELECT * FROM person WHERE phoneNumber = :phoneNumber");
		$stmt->bindParam(':phoneNumber', $phoneNumber);
		$stmt->execute();
	...
	public function updatePassword($phoneNumber, $pass) {
		$stmt = $this->conn->prepare("UPDATE person SET password = :password WHERE phoneNumber = '" . $phoneNumber . "'");
